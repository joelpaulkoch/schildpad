...
class AppWidget extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  AppWidget_DrawableData get icon => $_getN(3);
  ...
  @$pb.TagNumber(4)
  AppWidget_DrawableData ensureIcon() => $_ensure(3);

  @$pb.TagNumber(6)
  AppWidget_DrawableData get preview => $_getN(4);
  ...
  @$pb.TagNumber(6)
  AppWidget_DrawableData ensurePreview() => $_ensure(4);

  @$pb.TagNumber(7)
  $core.int get targetWidth => $_getIZ(5);
  ...
  @$pb.TagNumber(7)
  $core.bool hasTargetWidth() => $_has(5);

  @$pb.TagNumber(7)
  void clearTargetWidth() => clearField(7);

  @$pb.TagNumber(8)
  $core.int get targetHeight => $_getIZ(6);
  ...
  @$pb.TagNumber(8)
  $core.bool hasTargetHeight() => $_has(6);

  @$pb.TagNumber(8)
  void clearTargetHeight() => clearField(8);

  @$pb.TagNumber(9)
  $core.int get minWidth => $_getIZ(7);
  ...
  @$pb.TagNumber(9)
  $core.bool hasMinWidth() => $_has(7);

  @$pb.TagNumber(9)
  void clearMinWidth() => clearField(9);

  @$pb.TagNumber(10)
  $core.int get minHeight => $_getIZ(8);
